...
def parse_affiliation_multiple(text: str, method_num: int) -> list:
    base_url = SETTINGS.AAA_AFFILIATION_PARSER_ENDPOINT.rstrip('/') + '/'
    query = f"?text={quote(text)}&model={method_num}"
